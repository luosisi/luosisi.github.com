...
$(function(){
    /*$(".index-bottoma").click(function(){
    $(this).children("span").attr("class","bottom-spangreen");
    $(this).siblings().children("span").attr("class","bottom-span");
    })*/
    $(".classify-lei li").click(function(){
        $(this).addClass("bg-white").siblings().removeClass("bg-white");
        var i=$(this).index();
        $(".classify-right").eq(i).removeClass("dnone").siblings().addClass("dnone");
    })
})
